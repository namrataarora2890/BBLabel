...
import java.io.Serializable;
//import com.tricktekno.animatedsplash.databinding.RowSampleBinding;


public class ShowPerformanceActivity extends AppCompatActivity {
    private List<Sample> samples;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.showperformance);
