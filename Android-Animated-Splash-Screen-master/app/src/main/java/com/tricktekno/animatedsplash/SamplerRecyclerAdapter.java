...
class SamplesRecyclerAdapter extends RecyclerView.Adapter<SamplesRecyclerAdapter.SamplesViewHolder> {
    ...
    class SamplesViewHolder extends RecyclerView.ViewHolder {
